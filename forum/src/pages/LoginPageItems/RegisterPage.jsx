    ...
    return(
        ...
        <div style={{backgroundImage: `url(${outerbg})`}} className="overflow-x-hidden w-[100vw] h-[100vh] bg-gradient-to-b from-[#92dcc9] via-[#8cd4bc] to-[#85ccab]   mt-[75px] md:mt-[90px] overflow-hidden">
            ...
            <div style={{backgroundImage: `url(${innerbg})`}} className="flex bg-gradient-to-b from-[#20325e] via-[#264c6f] to-[#2b6a7d] sm:w-[600px] sm:h-[600px] w-[95%] h-[90%] my-[15px] mx-auto overflow-hidden justify-center items-center rounded-lg shadow-lg shadow-[#576264]">
                <div className='rounded-tr-[46px] rounded-bl-[46px] border-white border-2 w-[360px] h-[65%] align-middle justify-center overflow-hidden'>
                    ...
                    <div className=' w-[80%] mt-[30px] mx-auto align-middle justfiy-center'>
                        ...
                        <input type="text" className='transition-transform hover:-translate-y-[2px] bg-[#ede8f5] hover:bg-[#92dcc9] placeholder-slate-600 mt-[5px] w-[100%] mt-[5px] w-[100%] rounded-r-full' placeholder='your name?!'></input>
                        </div>

                        <div className='mt-[6px]'>
                        <label className='text-[#ede8f5] font-semibold'>Email</label>
                        <input type="email" className='transition-transform hover:-translate-y-[2px] bg-[#ede8f5] hover:bg-[#92dcc9] placeholder-slate-600 mt-[5px] w-[100%] mt-[5px] w-[100%] rounded-r-full' placeholder='email@mail.com'></input>
                        </div>
