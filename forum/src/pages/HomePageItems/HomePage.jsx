...
function HomePage() {
  ...
  return (
      <>
      <Navbar/>
      <div className='bg-slate-200 w-[100vw] h-[274vh] lg:h-[100vh] lg:mt-[90px]'>
        ...
        <div className='bg-[#d4f1f5] w-[100%] pb-[15px] lg:pb-0 overflow-hidden lg:hidden content-start'>
        ...
        <div id="gambarbesar" style={{backgroundImage:`url(${Background2})`}} className="align-bottom flex hidden mt-[75px] h-[100vh] w-[100vw] lg:block lg:overflow-hidden bg-cover bg-no-repeat bg-center">
          <div className='mt-4 flex h-64 w-[100%] justify-between'>
          ...
          <p className='hover:text-slate-950'>Samudra adalah forum tempat siswa-siswi SMA/Sederajat untuk mengekspresikan
            dan membagikan kondisi kesehatan mental mereka dengan siswa-siswi lainnya.</p>  
          </div>
          </div>
