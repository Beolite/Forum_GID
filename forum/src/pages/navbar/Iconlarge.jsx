...
function Iconlarge() {
    ...
    return (
        <div className="text-white items-center hidden sm:flex sm:w-[100%] w-[50%] h-[50%] justify-end mx-[20px] font-semibold my-auto">
                ...
                <Link className="hover:text-[#92dcc9] mx-[10px] lg:mx-[20px] hover:transform hover:scale-125 transition-transform">Forum</Link>
                <Link className="hover:text-[#92dcc9] mx-[10px] lg:mx-[20px] hover:transform hover:scale-125 transition-transform">Edukasi</Link>
                <Link className="hover:text-[#92dcc9] mx-[10px] lg:mx-[20px] hover:transform hover:scale-125 transition-transform">Panduan</Link>
